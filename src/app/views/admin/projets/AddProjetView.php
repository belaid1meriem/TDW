...
class AddProjetView extends AdminLayout
{
    ...
    private function renderProjetForm()
    {
        ob_start();
        ?>
        <form method="POST" action="<?= $this->asset('admin/projets/store') ?>" id="projetForm">
            <?= Components::Card([
    ...
    private function renderProjetSection()
    {
        ...
        <div style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 1rem;">
            ...
            <?= Components::Select([
                ...
                'value' => $this->old('status', 'en cours'),
